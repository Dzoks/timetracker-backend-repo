...
public class UserHasProjectRepositoryImpl implements UserHasProjectRepositoryCustom {
    ...
    private final String SQL_GET_ALL_CUSTOM="SELECT uhp.id,user_id,project_id,first_name,last_name,hour_rate,SUM(hours) AS total_hours,SUM(turnover) AS total_turnover" +
